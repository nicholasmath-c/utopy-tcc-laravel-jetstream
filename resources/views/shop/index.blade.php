    ...
    <div class="  flex flex-col p-6">
        ...
        <div class=" flex flex-col p-6">
            ...
            <div
                ...
                <div class=" h-36 w-44 ">
                    <img class=" h-36 w-44 rounded-md " src="{{ url('img/games_img/OriAndTheBlindForest2.jpeg') }}"
                        alt="">
                </div>
            ...
            <div
                class=" flex flex-row items-center shadow-xl rounded-md border-2 h-40 p-1 border-slate-800 hover:border-red-500 ease-in-out duration-150 hover:cursor-pointer ">
            ...
            <div
                ...
                <div class=" h-36 w-44 ">
                    <img class=" h-36 w-44 rounded-md " src="{{ url('img/games_img/silksong.webp') }}"
                        alt="">
                </div>
