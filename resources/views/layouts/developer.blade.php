            ...
            <div class="flex flex-col justify-between flex-1 mt-6">
                <nav class="-mx-3 space-y-6 ">
                    ...
                    <div class="space-y-3">
                        ...
                        <a class="flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-main-500 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-white {{ request()->routeIs('developer') ? 'text-white' : 'text-slate-400' }}"
                    ...
                    <div class="space-y-3 ">
                        ...
                        <a class="flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg hover:bg-main-500 hover:text-white {{ request()->routeIs('developer-game.index') ? 'text-white' : 'text-slate-400' }}"
                            href="{{ route('developer-game.index') }}">
                        ...
                        <a class="flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg hover:bg-main-500 hover:text-white {{ request()->routeIs('developer-game.create') ? 'text-white' : 'text-slate-400' }} hover:fill-white"
                            href="{{ route('developer-game.create') }}">
                            <svg class="ml-1 h-5 w-5 items-center stroke-slate-200 text-slate-200 fill-slate-200 decoration-slate-200 hover:stroke-white hover:text-white hover:fill-white hover:decoration-white {{ request()->routeIs('developer-game.create') ? 'stroke-white text-white fill-white decoration-white' : 'stroke-slate-400 text-slate-400 fill-slate-400 decoration-slate-400' }}"
