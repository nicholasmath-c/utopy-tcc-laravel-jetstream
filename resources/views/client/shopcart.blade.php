                    ...
                    <div class="  mb-10 pl-10 pb-3 pr-28">
                        <div class="rounded-md border-2 p-2 bg-gray-900 border-slate-600 hover:border-red-500 ease-in-out duration-150  flex flex-row ">
                            ...
                            <div class="flex flex-col justify-center  h-32 w-32">
                                ...
                                <img class=" object-contain h-32 rounded-sm  "
                                src="{{ url('storage/games/Celeste/Celeste-Cover.png') }}" alt="">
                            ...
                            <div class=" w-96">
                                ...
                                <div class=" pt-6 w-52">
                                    <x-button class=" ml-3 h-6 w-15">JOGO BASE</x-button>
                            ...
                            <div class="flex flex-col self-end items-center pt-6 pb-2 ">
                                <h1 class=" mr-10 text-gray-500 text-lg line-through ">R$40,00</h1>
                                <h1 class="  mr-11 ml-3 text-1xl ">R$20,00</h1>
                                <a class=" mt-10 text-sm underline text-gray-500 hover:text-red-500 mr-2 "
                                    href="">Remover</a>
                                <hr class=" mt-2">
                            </div>
                        </div>
