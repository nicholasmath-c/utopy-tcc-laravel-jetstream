...
class DeveloperGameController extends Controller
{
    ...
    public function index()
    {
        ...
        $game = GameController::getAllGameDeveloperPaginate($developer->id, 8);

        return view('developer.game.index', compact('game'));
    }
    ...
    public function create()
    {
        ...
        return view('developer.game.create')->with(compact('genreGame', 'developer'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($game && $rm && $rr)
            return redirect()->route('developer-game.index')->with('message', 'Jogo criado com sucesso!');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('developer.game.edit', compact('game', 'developer', 'genreGame', 'rm', 'rr'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($game && $rm && $rr)
            return redirect()->route("developer-game.index")->with('message', 'Jogo atualizado com sucesso!');
    }
