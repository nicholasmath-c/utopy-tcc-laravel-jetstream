        ...
        <div class=" mt-16 ">
            <div class="flex flex-row">
                ...
                <div class=" max-w-4xl pr-4">
                    ...
                    <img class=" rounded-md " src="{{ url('img/games_img/CelesteBanner.jpeg') }}">
                </div>

                <div class="items-center pt-20">
                    <img class="max-w-xs rounded-md " src="{{ url('img/games_img/CelesteBanner.jpeg') }}">
                    <div class="pt-4">
                        <p class="flex flex-row text-white text-lg"> <span class=" text-gray-500">Desenvolvedor -</span>
                            <span class=" pl-6"> Cherry </span>
                        </p>
                        <hr class=" rounded-md" >
                        <p class="text-white text-lg"> <span class=" text-gray-500">Categoria -</span> <span
                                class=" pl-6"> Aventura </span> </p>
                        <hr class=" rounded-md" >
