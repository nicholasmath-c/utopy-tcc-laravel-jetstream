                    ...
                    <div class="mb-15 pl-10 pb-3 pr-28">
                        <div
                            ...
                            <div class="flex flex-cojustify-center h-62 w-52">
                                ...
                                <img class=" object-contain  mt-2 rounded-sm  "
                            ...
                            <div class=" w-96">
                                <div class=" pt-6 w-52">
                                    <x-button class="ml-5 h-6 w-15">{{ $games->genreGame->name }}</x-button>
                            ...
                            <div class="flex flex-col self-end items-center pt-6 pb-2 ">
                                <h1 class=" mr-8 text-gray-500 text-lg line-through ">R${{ $games->price }}</h1>
