    ...
    <section class="min-h-screen  bg-gradient-to-r from-slate-900 via-slate-900 to-slate-900 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900">
        <div class="container mx-auto flex min-h-screen flex-col px-6 py-12">
            ...
            <div class="text-white lg:mx-6 lg:w-1/2">
                ...
                <p class="mt-6 max-w-xl">Pergunte-nos tudo e gostaríamos de ouvir de você</p>
                ...
                <p class="-mx-2 flex items-start">
                    ...
                    <span class="mx-2 w-80  text-white"> R. Tupinambás, 572 - Jardim Nova Belem, Francisco Morato - SP, 07909-065 </span>
                </p>
                ...
                <p class="-mx-2 flex items-start">
                    ...
                    <span class="mx-2 w-72 truncate text-white">(11) 4002-8922</span>
                </p>
                ...
                <p class="-mx-2 flex items-start">
                    ...
                    <span class="mx-2 w-72 truncate text-white">help@utopy.com</span>
                </p>
                </div>

                <div class="mt-6 md:mt-8">
                <h3 class="text-gray-300">Siga-nos</h3>
                ...
                <div class="-mx-1.5 mt-4 flex">
                    ...
                    <a class="mx-1.5 transform text-white transition-colors duration-300 hover:text-blue-800" href="#">
                    ...
                    <a class="mx-1.5 transform text-white transition-colors duration-300 hover:text-gray-500" href="#">
                    <svg class="h-8 w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 10.2222V13.7778H9.66667V20H13.2222V13.7778H15.8889L16.7778 10.2222H13.2222V8.44444C13.2222 8.2087 13.3159 7.9826 13.4826 7.81591C13.6493 7.64921 13.8754 7.55556 14.1111 7.55556H16.7778V4H14.1111C12.9324 4 11.8019 4.46825 10.9684 5.30175C10.1349 6.13524 9.66667 7.2657 9.66667 8.44444V10.2222H7Z" fill="currentColor" />
                    </svg>
                    </a>

                    <a class="mx-1.5 transform text-white transition-colors duration-300 hover:text-main-500" href="#">
                    <svg class="h-8 w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
