...
class GameSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Game::create([
            ...
            'short_description' => 'Em "Five Nights at Freddy\'s: Sister Location", mergulhe em uma experiência aterrorizante em uma nova localização dos famosos animatrônicos assustadores.',
            'long_description' => '
