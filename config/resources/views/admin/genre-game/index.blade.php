<x-admin-layout>
 ...
 <x-button class="w-auto mb-10 align-center"><a href="{{ route('game.genre.create') }}" class="">Nova
                            Categoria</a>
                    </x-button>
                </div>
...
<tbody class="bg-slate-100">
                            ...
                            <tr>
                                ...
                                <td class="pxz6 py-4">
                                    <a href="{{ route('game.genre.edit', ['id' => $categoria->id]) }}" class="font-medium text-slate-700 hover:underline">
                                        Edit
                                    </a>
                                </td>
                            </tr>
