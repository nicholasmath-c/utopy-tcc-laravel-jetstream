        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="bg-slate-800 p-10 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        <form id="form" method="POST" action="{{ route('admission-developer.store') }}"
                            enctype="multipart/form-data" class="text-white">
                            @csrf

                            <div class="mb-16">
                                <h1 class="font-heading text-white text-2xl mb-5">Formulário de Admissão</h1>
                            ...
                            <div class='md:grid md:grid-cols-3 md:gap-6 mb-20'>
                                <div>
                                    <div name="title" class="text-lg font-medium mb-2">CPF</div>
                                    <div name="description" class="text-sm text-slate-400">Insira o seu CPF.</div>
                                </div>
                                <div class="mt-5 md:mt-0 md:col-span-2">
                                    <x-input type="text" name="cpf" id="cpf" class="w-full" required
                                        maxLength="11" />
                                </div>
                            </div>
                            ...
                            <div class="mb-16">
                                <h1 class="font-heading text-white text-xl mb-5">Adicionar jogo para admissão</h1>
                            </div>
...
<script>
    ...
    $("#cpf").on("input", function() {
        var cpf = $(this).val().replace(/\D/g,
            ''); // Remove todos os caracteres não numéricos do valor do campo CPF
        if (cpf.length === 11) { // Verifica se o CPF tem 11 dígitos
            cpf = cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'); // Formata o CPF: XXX.XXX.XXX-XX
        }
        $(this).val(cpf); // Define o valor formatado no campo CPF
    });
