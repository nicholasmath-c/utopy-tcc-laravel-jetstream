                ...
                <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                    <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                        ...
                        <nav class="mb-10 list-none">
                            <li class="mt-3">
                                <a href="{{ route('about') }}" class="text-gray-500 cursor-pointer hover:text-white">A Utopy</a>
                            </li>
                        </nav>
                    </div>
                    <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                        ...
                        <nav class="mb-10 list-none">
                            <li class="mt-3">
                                <a href="{{ route('home') }}" class="text-gray-500 cursor-pointer hover:text-white">Início</a>
                            </li>
                            <li class="mt-3">
                                <a href="{{ route('shop') }}" class="text-gray-500 cursor-pointer hover:text-white">Loja</a>
                            </li>
                        </nav>
                    </div>
                    ...
                    <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                        ...
                        <nav class="mb-10 list-none">
                            <li class="mt-3">
                                <a href="{{ route('contact') }}" class="text-gray-500 cursor-pointer hover:text-white">Mande sua mensagem</a>
                            </li>
                            <a target="_blank" href="https://api.whatsapp.com/send?phone=5511940538966" class="text-gray-500 cursor-pointer hover:text-white">
