                ...
                <section class="py-10">
                    <div class="mx-auto grid grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        @foreach ($game as $games)
                            <article
                                class="rounded-xl bg-slate-900 p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
                                <a href="#">
                                    ...
                                    <div class="mt-1 p-2">
                                        ...
                                        <div class="mt-3 flex items-end justify-between">
                                            ...
                                            <div class="flex flex-row gap-2">
                                                ...
                                                <form action="" method="POST" class="delete inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
